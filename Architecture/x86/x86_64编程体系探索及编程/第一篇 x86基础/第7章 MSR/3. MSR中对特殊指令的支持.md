...
* [0 概述](#0-概述)
* [1 支持sysenter/sysexit指令的MSR](#1-支持sysentersysexit指令的msr)
* [2 支持syscall/sysret指令的MSR](#2-支持syscallsysret指令的msr)
* [3 支持swapgs指令的MSR](#3-支持swapgs指令的msr)
* [4 支持monitor/mwait指令的MSR](#4-支持monitormwait指令的msr)
...
sysenter/sysexit在**实模式下是无效**的。在**Intel**的机器上**sysenter/sysexit**指令可以在**long mode**下使用。而在**AMD**上sysenter/sysexit指令在**long mode是无效**的，需要注意这些区别。这里的描述以Intel的平台为主。
