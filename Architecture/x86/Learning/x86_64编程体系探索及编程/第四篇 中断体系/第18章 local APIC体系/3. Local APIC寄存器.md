...
* [1 local APIC寄存器地址](#1-local-apic寄存器地址)
	* [1.1 local APIC寄存器基地址](#11-local-apic寄存器基地址)
		* [1.1.1 local APIC寄存器重定位](#111-local-apic寄存器重定位)
* [2 local APIC寄存器列表](#2-local-apic寄存器列表)
