...
;; ʵ�� 18-15������ logcal processor 1 �� PMI �ж�

;  ���� logical processor 1 �� IPI handler
	mov esi, PROCESSOR1_IPI_VECTOR                                          ; ���͸������� 1 �� IPI �ж� vector
	mov edi, processor1_ipi_handler                                         ; IPI �ж� handler
	call set_interrupt_handler
...
do_apic_perfmon_handler:	
        mov esi, ph_msg1                	; ��ӡ��Ϣ
        call puts
        call dump_apic                        ; ��ӡ local APIC�Ĵ�����Ϣ
