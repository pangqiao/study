...
现代 8259 一般连在 **BSP** lapic 的 LINT0 上或者 I/O APIC 的 IRQ0 上

* 如果 lapic 启用了:

  * 连接在 I/O APIC 的 RTE0 上, 可以屏蔽 I/O APIC 的 RTE0, 从而让 BSP lapic 处理.

  * 连接在 LAPIC 的 LINT0 上, 可以屏蔽 BSP lapic 的 LVT LINT0, 从而让 I/O APIC 统一处理.

* 如果 lapic 没有启用, 需要连接在 LINT0 上, 被直接作为处理器的 INTR pin 使用, 只能由 BSP 响应.
