...
查询平台的CPU信息, 通过CPU具体型号(Intel(R) Xeon(R) Gold 6130 CPU @ 2.10GHz)查询wikichip(https://en.wikichip.org/wiki/intel/xeon_gold/6130)获取微架构(Skylake)、平台(Purley)、芯片组(Lewisburg)、Core Name(Skylake SP)、Core Family(6)等信息, 当然这些具体信息要和
