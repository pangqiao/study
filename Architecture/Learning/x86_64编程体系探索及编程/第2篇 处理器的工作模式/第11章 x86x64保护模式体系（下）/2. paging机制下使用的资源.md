...
- [寄存器](#寄存器)
- [CPUID查询leaf](#cpuid查询leaf)
  - [CPUID.01H leaf功能](#cpuid01h-leaf功能)
  - [CPUID.07H leaf功能](#cpuid07h-leaf功能)
  - [CPUID.80000001H leaf功能](#cpuid80000001h-leaf功能)
- [寄存器的控制位](#寄存器的控制位)
- [4 页转换表资源](#4-页转换表资源)
