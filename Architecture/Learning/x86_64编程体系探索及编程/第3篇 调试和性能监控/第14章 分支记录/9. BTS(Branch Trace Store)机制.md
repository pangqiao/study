...
- [Debug Store存储区域](#debug-store存储区域)
  ...
  - [DS 组成](#ds-组成)
  - [DS 格式](#ds-格式)
  - [DS 区域基地址与 BTS 域地址](#ds-区域基地址与-bts-域地址)
  - [DS 管理区域](#ds-管理区域)
    - [BTS与PEBS buffer base](#bts与pebs-buffer-base)
    - [BTS与PEBS index](#bts与pebs-index)
    - [BTS与PEBS maximum](#bts与pebs-maximum)
