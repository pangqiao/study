...
- [counter（计数器）](#counter计数器)
  - [IA32_PMC与IA32_FIXED_CTR寄存器](#ia32_pmc与ia32_fixed_ctr寄存器)
  - [触发PMI](#触发pmi)
  - [触发PEBS中断](#触发pebs中断)
- [开启计数器](#开启计数器)
- [全局控制器](#全局控制器)
- [通用计数控制器](#通用计数控制器)
  - [Event Select（bit7～bit0）](#event-selectbit7~bit0)
  - [Unit mask（bit15～bit8）](#unit-maskbit15~bit8)
  - [USR（bit16）](#usrbit16)
  - [OS（bit17）](#osbit17)
  - [E（bit18）](#ebit18)
  - [PC（bit19）](#pcbit19)
  ...
  - [EN（bit22）](#enbit22)
  - [INV（bit23）](#invbit23)
  - [Counter mask（bit31～bit24）](#counter-maskbit31~bit24)
- [固定用途计数控制器](#固定用途计数控制器)
  - [EN域](#en域)
  - [ANY位](#any位)
  - [PMI位](#pmi位)
  - [同时开启多个计数器](#同时开启多个计数器)
- [全局状态寄存器](#全局状态寄存器)
  - [OvfBuffer位（bit62）](#ovfbuffer位bit62)
  - [CondChgd位（bit63）](#condchgd位bit63)
  - [值得注意](#值得注意)
- [全局溢出控制器](#全局溢出控制器)
