...
- [PEBS buffer](#pebs-buffer)
  - [64位的PEBS记录格式](#64位的pebs记录格式)
  - [增强的PEBS记录格式](#增强的pebs记录格式)
  - [IA32_PERF_CAPABILITIES寄存器](#ia32_perf_capabilities寄存器)
  - [PEBS buffer区域](#pebs-buffer区域)
  - [PEBS buffer的maximum与threshold值](#pebs-buffer的maximum与threshold值)
  - [PEBS reset counter值](#pebs-reset-counter值)
- [PEBS中断](#pebs中断)
...
## PEBS buffer的maximum与threshold值
