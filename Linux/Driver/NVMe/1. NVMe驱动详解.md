...
会判断**总线** `drivers_autoprobe` 是否为 1(总线支持自动, 函数 `driver_attach()` 会遍历该驱动的所有设备, 并尝试将设备绑定到驱动上, 也就是设备的 probe, 具体见下一节
...
NVMe驱动详解系列: https://blog.csdn.net/weixin_33728708/article/details/89