...
- [6. Perf性能事件](#6-perf性能事件)
  - [6.1. 三种类型性能事件](#61-三种类型性能事件)
    - [6.1.1. 硬件性能事件](#611-硬件性能事件)
    - [6.1.2. 软件性能事件](#612-软件性能事件)
    - [6.1.3. Tracingpoint事件](#613-tracingpoint事件)
    - [6.1.4. 动态追踪](#614-动态追踪)
    - [6.1.5. 事件限定符](#615-事件限定符)
