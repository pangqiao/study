...
- [3. Perf 安装](#3-perf-安装)
  ...
  - [3.3. 安装](#33-安装)
  - [3.4. 帮助文档](#34-帮助文档)
- [4. Perf性能事件](#4-perf性能事件)
  - [4.1. 三种类型性能事件](#41-三种类型性能事件)
    - [4.1.1. 硬件性能事件](#411-硬件性能事件)
    - [4.1.2. 软件性能事件](#412-软件性能事件)
    - [4.1.3. Tracingpoint事件](#413-tracingpoint事件)
    - [4.1.4. 动态追踪](#414-动态追踪)
    - [4.1.5. 事件限定符](#415-事件限定符)
  - [4.2. 性能事件的属性](#42-性能事件的属性)
    - [4.2.1. PMI中断和PEBS中断](#421-pmi中断和pebs中断)
    - [4.2.2. 性能事件的精度级别](#422-性能事件的精度级别)
    - [4.2.3. 其他属性](#423-其他属性)
  - [4.3. 没有预定义字符描述的硬件性能事件](#43-没有预定义字符描述的硬件性能事件)
  - [4.4. perf list查看所有性能事件](#44-perf-list查看所有性能事件)
  - [4.5. 性能事件指定错误](#45-性能事件指定错误)
...
- [6. 简单示例](#6-简单示例)
  - [6.1. cycles原理](#61-cycles原理)
    - [6.1.1. Symbols](#611-symbols)
