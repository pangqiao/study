...
- [9. 例子](#9-例子)
  ...
  - [9.2. Static Kernel Tracing: 静态内核态追踪](#92-static-kernel-tracing-静态内核态追踪)
  - [9.3. Static User Tracing: 静态用户态追踪](#93-static-user-tracing-静态用户态追踪)
...
## 9.2. Static Kernel Tracing: 静态内核态追踪

## 9.3. Static User Tracing: 静态用户态追踪
