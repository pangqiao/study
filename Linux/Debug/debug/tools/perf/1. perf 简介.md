...
- [3. 一个简单例子](#3-一个简单例子)
- [4. 常用命令](#4-常用命令)
  - [4.1. 三种命令划分](#41-三种命令划分)
  - [Listing: 列出事件](#listing-列出事件)
  - [Counting: 计数统计事件](#counting-计数统计事件)
  - [Profiling: 采样数据](#profiling-采样数据)
  - [static tracing: 静态跟踪](#static-tracing-静态跟踪)
  - [Dynamic Tracing](#dynamic-tracing)
  - [Mixed](#mixed)
  - [Special](#special)
  - [Reporting](#reporting)
- [5. Perf的相关依赖](#5-perf的相关依赖)
  - [5.1. Symbols: 符号表](#51-symbols-符号表)
  - [5.2. perf annotate](#52-perf-annotate)
  - [5.3. Stack Traces](#53-stack-traces)
  - [5.4. 小结](#54-小结)
- [6. Perf 安装](#6-perf-安装)
  - [6.1. 安装依赖库](#61-安装依赖库)
  - [6.2. 测试](#62-测试)
  ...
  - [6.4. 安装](#64-安装)
  - [6.5. 帮助文档](#65-帮助文档)
- [7. Perf性能事件](#7-perf性能事件)
  - [7.1. 三种类型性能事件](#71-三种类型性能事件)
    - [7.1.1. 硬件性能事件](#711-硬件性能事件)
    - [7.1.2. 软件性能事件](#712-软件性能事件)
    - [7.1.3. Tracingpoint事件](#713-tracingpoint事件)
    - [7.1.4. 动态追踪](#714-动态追踪)
    - [7.1.5. 事件限定符](#715-事件限定符)
  - [7.2. 性能事件的属性](#72-性能事件的属性)
    - [7.2.1. PMI中断和PEBS中断](#721-pmi中断和pebs中断)
    - [7.2.2. 性能事件的精度级别](#722-性能事件的精度级别)
    - [7.2.3. 其他属性](#723-其他属性)
  - [7.3. 没有预定义字符描述的硬件性能事件](#73-没有预定义字符描述的硬件性能事件)
  - [7.4. perf list查看所有性能事件](#74-perf-list查看所有性能事件)
  - [7.5. 性能事件指定错误](#75-性能事件指定错误)
- [8. Perf 功能概述](#8-perf-功能概述)
  - [8.1. 全局性概况](#81-全局性概况)
  - [8.2. 全局细节](#82-全局细节)
  - [8.3. 特定功能分析](#83-特定功能分析)
  - [8.4. perf record](#84-perf-record)
  - [8.5. 可视化工具perf timechart](#85-可视化工具perf-timechart)
- [9. 简单示例](#9-简单示例)
  - [9.1. cycles原理](#91-cycles原理)
- [10. 参考](#10-参考)
