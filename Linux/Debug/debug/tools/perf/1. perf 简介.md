...
- [2. Perf 简介](#2-perf-简介)
  - [# 4. 基本原理](#4-基本原理)
  - [4.1. 三种工作模式](#41-三种工作模式)
    - [4.1.1. counting: 内核上下文的指标](#411-counting-内核上下文的指标)
    - [4.1.2. sampling: 基于事件的采样](#412-sampling-基于事件的采样)
    - [4.1.3. bpf: 用户自定义](#413-bpf-用户自定义)
- [3. Perf 编译安装](#3-perf-编译安装)
  ...
  - [3.4. 帮助文档](#34-帮助文档)
- [4.2. 简单示例](#42-简单示例)
  - [4.3. cycles原理](#43-cycles原理)
  - [4.4. 工作原理](#44-工作原理)
    - [4.4.1. Symbols](#441-symbols)
...
Linux内核实现了非常有价值的性能分析基础设施（perf infrastructure），可以用于剖析各种CPU或软件事件。这一功能由`perf_events`**接口**暴露，并提供 **perf** 这一**用户空间工具**，通过此工具，你可以发现以下问题的答案：
...
### 4.1.1. counting: 内核上下文的指标


### 4.1.2. sampling: 基于事件的采样
