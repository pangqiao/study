...
- [9. 例子](#9-例子)
  - [9.1. CPU Statistics: CPU统计](#91-cpu-statistics-cpu统计)
    ...
    - [Specific Counters](#specific-counters)
    - [Raw Counters](#raw-counters)
...
- [10. Visualizations: 可视化](#10-visualizations-可视化)
  - [10.1. Flame Graphs: 火焰图](#101-flame-graphs-火焰图)
    - [10.1.1. 示例](#1011-示例)
    - [10.1.2. 生成](#1012-生成)
- [11. Perf 功能概述](#11-perf-功能概述)
  - [11.1. 全局性概况](#111-全局性概况)
  - [11.2. 全局细节](#112-全局细节)
  - [11.3. 特定功能分析](#113-特定功能分析)
  - [11.4. perf record](#114-perf-record)
  - [11.5. 可视化工具perf timechart](#115-可视化工具perf-timechart)
- [12. 简单示例](#12-简单示例)
