...
```
./perf kvm stat record -a -p 178264
./perf kvm stat report
...
Analyze events for all VMs, all VCPUs:
           ...
           interrupt     569829    99.19%    98.94%      0.29us     72.07us      0.52us ( +-   0.16% )
                 msr       4638     0.81%     1.06%      0.34us      4.42us      0.68us ( +-   0.47% )
               vintr          3     0.00%     0.00%      0.72us      1.32us      1.00us ( +-  17.56% )

Total Samples:574470, Total events handled time:297227.96us.
```
...
Analyze events for all VMs, all VCPUs:
           ...
           interrupt     530773    95.22%    94.84%      0.29us     67.22us      0.65us ( +-   0.17% )
                 msr      26371     4.73%     5.09%      0.32us      8.85us      0.70us ( +-   0.23% )
               vintr        300     0.05%     0.07%      0.55us      1.69us      0.83us ( +-   1.00% )
                 nmi          1     0.00%     0.00%      0.41us      0.41us      0.41us ( +-   0.00% )
...
Total Samples:557445, Total events handled time:364849.75us.
```
