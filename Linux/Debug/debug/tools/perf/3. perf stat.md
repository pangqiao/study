...
- [4. 参数介绍](#4-参数介绍)
  ...
  - [4.7. 更多信息](#47-更多信息)
  - [4.8. 仅输出目标程序执行时间](#48-仅输出目标程序执行时间)
  - [4.9. 更多性能指标](#49-更多性能指标)
  - [4.10. 清理内存缓冲区](#410-清理内存缓冲区)
  - [4.11. 打印每个处理器上相应信息](#411-打印每个处理器上相应信息)
  - [4.12. 格式化输出](#412-格式化输出)
  - [4.13. 指定输出文件](#413-指定输出文件)
  - [4.14. 追加模式输出](#414-追加模式输出)
  - [4.15. pre执行](#415-pre执行)
  - [4.16. post执行](#416-post执行)
- [示例](#示例)
- [参考](#参考)
