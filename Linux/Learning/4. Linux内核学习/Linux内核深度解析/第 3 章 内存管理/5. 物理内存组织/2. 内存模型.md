...
根据page 计算出pfn核心思路就是根据page中的flag获取到相对应的section然后根据section中的mem_map计算出该page的pfn.理解page中的flag划分 以及nr的划分非常重要. 

注意section_mem_map里面包含一层转换使转换出的pfn为全局pfn而不是section mem_map内的pfn. 
