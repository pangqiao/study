...
- [6. 使用方法](#6-使用方法)
  - [6.1. mmap() 函数](#61-mmap-函数)
  - [6.2. mmap、SYSV共享内存异同](#62-mmap-sysv共享内存异同)
  - [6.3. 匿名映射](#63-匿名映射)
  - [6.4. 基于文件的映射](#64-基于文件的映射)
    - [6.4.1. 挂载 hugetlbfs](#641-挂载-hugetlbfs)
    - [6.4.2. 创建文件和创建内存映射](#642-创建文件和创建内存映射)
  - [6.5. shm](#65-shm)
  - [6.6. hugetlbfs 库](#66-hugetlbfs-库)
- [7. 实现原理](#7-实现原理)
