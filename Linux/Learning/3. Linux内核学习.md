...
- [4. 子系统学习](#4-子系统学习)
  ...
  - [4.2. 内核文档](#42-内核文档)
  - [4.3. 代码阅读](#43-代码阅读)
- [5. feature学习](#5-feature学习)
  - [5.1. 初始实现](#51-初始实现)
    - [5.1.1. 最初合入的patch/patchset](#511-最初合入的patchpatchset)
...
4. 《Professional Linux Kernel Architecture》, 《深入Linux内核架构》
...
2019-05, 基于Linux内核4.12版本，选择ARM64处理器架构
...
因为这里面往往体现了author提出这个patch set的**最初的原因**且实现比较简单; 而且有些人只有在最初的 patchset 才有写使用方法
