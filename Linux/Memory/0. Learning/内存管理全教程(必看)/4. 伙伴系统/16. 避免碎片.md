...
- [碎片化问题](#碎片化问题)
  - [今日内容(buddy伙伴系统如何避免碎片)](#今日内容buddy伙伴系统如何避免碎片)
- [依据可移动性组织页避免内存碎片](#依据可移动性组织页避免内存碎片)
  - [依据可移动性组织页](#依据可移动性组织页)
  - [迁移类型](#迁移类型)
  - [free_area的改进](#free_area的改进)
  - [迁移备用列表fallbacks](#迁移备用列表fallbacks)
  - [全局 pageblock_order 变量](#全局-pageblock_order-变量)
  - [gfpflags_to_migratetype转换分配标识到迁移类型](#gfpflags_to_migratetype转换分配标识到迁移类型)
  - [pageblock_flags变量与其函数接口](#pageblock_flags变量与其函数接口)
  - [/proc/pagetypeinfo获取页面分配状态](#procpagetypeinfo获取页面分配状态)
...
## gfpflags_to_migratetype转换分配标识到迁移类型
