...
- [7. 实现原理](#7-实现原理)
  ...
  - [7.3. 挂载hugetlbfs文件系统](#73-挂载hugetlbfs文件系统)
    - [7.2.3. hugetlbfs 文件系统](#723-hugetlbfs-文件系统)
    - [7.2.4. 虚拟内存与物理内存映射](#724-虚拟内存与物理内存映射)
  - [7.4. 创建文件](#74-创建文件)
...
* 调用 alloc_huge_page 函数从**空闲大内存页链表** `hugepage_freelists` 中**申请一个大内存页**.
