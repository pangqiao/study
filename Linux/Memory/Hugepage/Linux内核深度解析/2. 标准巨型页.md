...
- [2. 内核编译](#2-内核编译)
- [3. 内核启动参数](#3-内核启动参数)
- [4. 总的 HugePages 的查看与设置](#4-总的-hugepages-的查看与设置)
  - [4.1. 总的 HugePages 的查看](#41-总的-hugepages-的查看)
  - [4.2. /proc/sys/vm 接口](#42-procsysvm-接口)
    - [4.2.1. 永久的 HugePages](#421-永久的-hugepages)
    - [4.2.2. 分配策略](#422-分配策略)
    - [4.2.3. 超发的 HugePages](#423-超发的-hugepages)
  - [4.3. 参数之间的关系](#43-参数之间的关系)
  - [4.4. /sys/kernel/mm/hugepages/ 的接口](#44-syskernelmmhugepages-的接口)
...
## 4.4. /sys/kernel/mm/hugepages/ 的接口
