...
- [4. 总的 HugePages](#4-总的-hugepages)
  ...
  - [4.3. 总的 HugePages 的分配](#43-总的-hugepages-的分配)
  - [4.4. HugePages 分配策略](#44-hugepages-分配策略)
  - [4.5. HugePages超发](#45-hugepages超发)
  - [4.6. 参数之间的关系](#46-参数之间的关系)
  - [4.7. 在 /sys/kernel/mm/hugepages/ 的接口](#47-在-syskernelmmhugepages-的接口)
...
在`/proc/sys/vm`, 有 `/proc` 系统接口用于**调节 HugePages 参数**.
...
## 4.7. 在 /sys/kernel/mm/hugepages/ 的接口
