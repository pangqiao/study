...
```
[32504.406820] atkbd serio0: PM: calling serio_suspend+0x0/0x60 @ 1067, parent: i8042
[32504.406882] atkbd serio0: PM: serio_suspend+0x0/0x60 returned 0 after 54 usecs
[32504.406892] i8042 i8042: PM: calling platform_pm_suspend+0x0/0x60 @ 1067, parent: platform
[32504.407033] i8042 i8042: PM: platform_pm_suspend+0x0/0x60 returned 0 after 135 usecs
```

### pm_trace

控制“PM trace”机制, 在重新启动后会在 RTC 内存中保存最后一次 suspend 或 resume 的 event point.  它有助于更有效地调试由于系统 suspend 或 resume(更常见)期间发生的设备驱动进程故障而导致的硬锁定或重新启动. 
