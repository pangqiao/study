...
- [介绍](#介绍)
- [架构](#架构)
- [1. CPUFreq 驱动](#1-cpufreq-驱动)
- [2. CPUFreq 的策略](#2-cpufreq-的策略)
- [3. CPUFreq 的性能测试和调优](#3-cpufreq-的性能测试和调优)
- [4. CPUIdle 驱动](#4-cpuidle-驱动)
- [5. PowerTop](#5-powertop)
- [6. Regulator 驱动](#6-regulator-驱动)
- [7. OPP](#7-opp)
- [8. PM QoS](#8-pm-qos)
- [9. CPU 热插拔](#9-cpu-热插拔)
- [10. 挂起到 RAM](#10-挂起到-ram)
- [11. 运行时的 PM](#11-运行时的-pm)
