...
现在，我们一个一个查看所有CPU，并且**设置irq\_stack\_ptr**。事实证明它等于**中断栈的顶减去64**。为什么是64？TODO [[arch/x86/kernel/cpu/common.c](https://github.com/torvalds/linux/blob/master/arch/x86/kernel/cpu/common.c)] 代码如下：
