...
* [7 image镜像以及相关操作](#7-image镜像以及相关操作)
	* [7.1 利用commit将container转换成image镜像](#71-利用commit将container转换成image镜像)
	* [7.2 利用Dockerfile创建镜像](#72-利用dockerfile创建镜像)
...
[root@xxx ~]# docker exec -it container_name/container_id /bin/bash
```
