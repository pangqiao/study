...
利用exit退出容器. 注意此时docker引擎中就有两个容器, 可以使用


## 7.2 利用Dockerfile创建镜像


它是一个文本文件, 用来配置image. Docker根据该文件通过docker build命令生成二进制的image文件.

官方说明: [Dockerfile reference](https://docs.docker.com/engine/reference/builder/)
