...
- [2. 使用CRD扩展API资源](#2-使用crd扩展api资源)
  - [创建CRD的定义](#创建crd的定义)
  - [基于CRD的定义创建自定义资源对象](#基于crd的定义创建自定义资源对象)
  - [CRD的高级特性](#crd的高级特性)
  - [小结](#小结)
- [使用API聚合机制扩展API资源](#使用api聚合机制扩展api资源)
  - [在Master的API Server中启用API聚合功能](#在master的api-server中启用api聚合功能)
