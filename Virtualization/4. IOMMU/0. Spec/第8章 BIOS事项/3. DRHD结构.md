...
<caption>DRHD结构</caption>
  ...
  <tr>
    ...
    <td>
    为此单元重映射硬件寄存器集的基址. 此地址必须根据此结构的 Size 字段中报告的寄存器集大小的大小对齐.
    </td>
  </tr>
  <tr>
    <td>
...
<caption>Device Scope Entry</caption>
  ...
  <tr>
    ...
    对于类型值为 0x5（ACPI_NAMESPACE_DEVICE）的 Device Scope Entry，此字段描述平台为 ACPI name-space 设备分配的唯一 16 位source-id 的低 8 位 {设备、功能}。
    </td>
  </tr>
</table>
