...
<table style="width:100%">
<caption>Device Scope Structure</caption>
  <tr>
    <th>
    字段
    </th>
  ...
  <tr>
    ...
    <td>
    定义了如下值:
    <li><b>0x01</b>: PCI Endpoint Device - 由 “Path” 字段标识的设备是一个 PCI endpoint device。这种类型不能在设置了 INCLUDE_PCI_ALL flag 的 DRHD 结构的 Device Scope 中使用。</li>
    <li> </li>
    </td>
  </tr>
  <tr>
