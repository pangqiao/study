...
- [代码结构](#代码结构)
  - [开始执行](#开始执行)
  - [硬件模拟: /hw/](#硬件模拟-hw)
  - [目标机器: /target/arch/, 将客户机代码转为TCG操作码](#目标机器-targetarch-将客户机代码转为tcg操作码)
  - [主机: /tcg/, 将TCG操作码转换成主机代码](#主机-tcg-将tcg操作码转换成主机代码)
  - [文件总结和补充：](#文件总结和补充)
- [TCG - 动态翻译](#tcg-动态翻译)
- [TB链](#tb链)
- [QEMU的TCG代码分析](#qemu的tcg代码分析)
- [QEMU中的IOCTL](#qemu中的ioctl)
- [参考](#参考)
...
## 目标机器: /target/arch/, 将客户机代码转为TCG操作码
