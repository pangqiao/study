...
- [相关配置参数](#相关配置参数)
- [可热插拔的guest内存](#可热插拔的guest内存)
- [真实内存资源Memory backends](#真实内存资源memory-backends)
- [与内存相关的数据结构关系图](#与内存相关的数据结构关系图)
- [RAM blocks和ram\_addr\_t地址空间](#ram-blocks和ram_addr_t地址空间)
- [跟踪脏页](#跟踪脏页)
