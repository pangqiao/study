...
- [2. 结构体代码](#2-结构体代码)
  ...
  - [2.5. FlatView: 虚拟机物理地址空间](#25-flatview-虚拟机物理地址空间)
    ...
    - [FlatView 与 MemoryRegion](#flatview-与-memoryregion)
  - [2.6. MemoryRegionSection: 虚拟机物理地址空间GPA](#26-memoryregionsection-虚拟机物理地址空间gpa)
  - [2.7. KVMSlot: KVM内存条模型](#27-kvmslot-kvm内存条模型)
  - [kvm_userspace_memory_region: kvm参数](#kvm_userspace_memory_region-kvm参数)
...
## kvm_userspace_memory_region: kvm参数
