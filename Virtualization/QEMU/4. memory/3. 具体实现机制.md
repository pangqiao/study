...
- [5. MEMORY_LISTENER_UPDATE_REGION(): 新FlatRange的更新](#5-memory_listener_update_region-新flatrange的更新)
  - [5.1. kvm_set_phys_mem(): 修改内核内存](#51-kvm_set_phys_mem-修改内核内存)
    - [属性检查](#属性检查)
    - [kvm_align_section(): 得到section/fr的起始地址和大小](#kvm_align_section-得到sectionfr的起始地址和大小)
    - [计算该section/fr对应的主机虚拟机地址(HVA)](#计算该sectionfr对应的主机虚拟机地址hva)
    - [kvm_set_user_memory_region(): 转化为slot然后添加](#kvm_set_user_memory_region-转化为slot然后添加)
- [6. 总结](#6-总结)
- [7. 参考](#7-参考)
...
### kvm_align_section(): 得到section/fr的起始地址和大小
...
### kvm_set_user_memory_region(): 转化为slot然后添加
