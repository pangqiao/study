...
qemu要把**MemoryRegion**映射到cpu看到的**线性地址上**(**AddressSpace**), 但是有些情况两个设备的内存映射到相同的线性地址, 比如mmio. 举个例子,对于一个内存条是4g, 它的线性地址为0-4g, 但是vga设备的内存地址通过mmio映射到线性地址的768k–(768+256k), 这种情况应该使vga的线性地址覆盖掉ram的768k–(768+256k)地址,这样写vga地址才能成功.
