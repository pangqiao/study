...
- [2. VFIO 框架简介](#2-vfio-框架简介)
  - [vfio interface](#vfio-interface)
  - [vfio_iommu 和 vfio_pci](#vfio_iommu-和-vfio_pci)
  - [iommu driver 和 pci bus driver](#iommu-driver-和-pci-bus-driver)
- [三个核心概念](#三个核心概念)
  - [Group](#group)
  - [Device](#device)
  - [Container](#container)
  - [三个的关系](#三个的关系)
- [3. VFIO 数据结构](#3-vfio-数据结构)
  - [3.1. vfio_container](#31-vfio_container)
  - [3.2. vfio_group](#32-vfio_group)
  - [3.3. device](#33-device)
  - [3.4. vfio_iommu_driver](#34-vfio_iommu_driver)
  - [3.5. 小结](#35-小结)
- [4. VFIO 中的技术关键点](#4-vfio-中的技术关键点)
...
从上图可以看出, 一个或多个 device 从属于某个 group, 而一个或多个 group 又从属于一个 container.
