...
- [1. DMA介绍](#1-dma介绍)
  ...
  - [DMA Remapping的引入](#dma-remapping的引入)
...
DMA Remapping的基本思想如图所示, 当虚拟机让设备进行DMA时, 指定的是GPA地址, 在经过 DMA Remapping 之后, 该 GPA 地址会被转换成 QEMU/KVM 为其分配的物理地址. 这一点与右边CPU进行访问时EPT的作用是一样的.
