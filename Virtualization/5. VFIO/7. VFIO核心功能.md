...
实际上, vfio_group_status 只包含一个 flag, 为其定义了两个位 VFIO_GROUP_FLAGS_VIABLE 和VFIO_GROUP_FLAGS_CONTAINER_SET,后者显然表示VFIO Group是否绑定到了某个Container,Viable的含义可参考vfio_dev_viable函数的注释:
