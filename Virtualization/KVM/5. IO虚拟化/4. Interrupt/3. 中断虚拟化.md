...
- [5. 中断注入的触发](#5-中断注入的触发)
  - [5.1. 整体流程](#51-整体流程)
  - [5.2. kvm_set_irq(): 中断触发](#52-kvm_set_irq-中断触发)
  - [5.3. PIC中断触发](#53-pic中断触发)
    - [5.3.1. 整体流程](#531-整体流程)
    - [5.3.2. kvm_set_pic_irq(): pic的触发方法](#532-kvm_set_pic_irq-pic的触发方法)
  - [5.4. IOAPIC中断触发](#54-ioapic中断触发)
    - [5.4.1. 整体流程](#541-整体流程)
    - [5.4.2. kvm_set_ioapic_irq(): ioapic的触发方法](#542-kvm_set_ioapic_irq-ioapic的触发方法)
      - [5.4.2.1. ioapic_service(): 根据RTE构建中断消息发往lapic](#5421-ioapic_service-根据rte构建中断消息发往lapic)
      - [5.4.2.2. kvm_irq_delivery_to_apic(): 投递消息到lapic](#5422-kvm_irq_delivery_to_apic-投递消息到lapic)
  - [5.5. MSI中断触发函数](#55-msi中断触发函数)
    - [5.5.1. 整体流程](#551-整体流程)
    - [5.5.2. kvm_set_msi(): msi的触发方法](#552-kvm_set_msi-msi的触发方法)
  - [5.6. __apic_accept_irq(): LAPIC接收中断](#56-__apic_accept_irq-lapic接收中断)
...
### 5.3.2. kvm_set_pic_irq(): pic的触发方法
...
### 5.4.2. kvm_set_ioapic_irq(): ioapic的触发方法
...
#### 5.4.2.1. ioapic_service(): 根据RTE构建中断消息发往lapic
...
#### 5.4.2.2. kvm_irq_delivery_to_apic(): 投递消息到lapic
...
## 5.6. __apic_accept_irq(): LAPIC接收中断
