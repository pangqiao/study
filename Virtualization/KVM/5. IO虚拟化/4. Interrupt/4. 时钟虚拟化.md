...
- [3. PIT(8254)模拟](#3-pit8254模拟)
  ...
  - [3.3. 创建定时器](#33-创建定时器)
    - [3.3.1. 整体流程](#331-整体流程)
    - [3.3.2. 入口代码](#332-入口代码)
    - [3.3.3. create_pit_timer(): 创建定时器](#333-create_pit_timer-创建定时器)
    - [3.3.4. pit_timer_fn(): 中断流程](#334-pit_timer_fn-中断流程)
- [4. 参考](#4-参考)
