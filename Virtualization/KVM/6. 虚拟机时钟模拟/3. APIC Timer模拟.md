...
- [4. 启动定时器](#4-启动定时器)
  ...
  - [4.5. restart_apic_timer(): 重启apic timer定时器](#45-restart_apic_timer-重启apic-timer定时器)
    ...
    - [4.5.5. apic_timer_expired(): apic timer已经到期处理](#455-apic_timer_expired-apic-timer已经到期处理)
...
start_apic_timer()  // 启动apic timer定时器
 ...
 |       |   |   |   └─ apic->lapic_timer.tscdeadline = kvm_read_l1_tsc(apic->vcpu, tscl) + nsec_to_cycles(apic->vcpu, delta); // 
...
### 4.5.5. apic_timer_expired(): apic timer已经到期处理
