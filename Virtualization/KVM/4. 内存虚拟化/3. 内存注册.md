    ...
    kvm_vm_ioctl_set_memory_region()
        kvm_set_memory_region()
            __kvm_set_memory_region()
                kvm_set_memslot()
                    struct kvm_memory_slot new; // 生成新slot, 对于删除的情况, new所有置为0, 
                    ...
                    update_memslots(slots, new, change); // 更新memslots数组(即slots), 没有具体动作
                    slots = install_new_memslots(kvm, as_id, slots); //将新的slots
