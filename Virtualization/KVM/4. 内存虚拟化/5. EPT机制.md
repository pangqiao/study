...
- [5. EPT构建过程](#5-ept构建过程)
  ...
  - [5.3. EPT异常处理流程](#53-ept异常处理流程)
    ...
    - [5.3.2. kvm_tdp_page_fault(): 建立页表项](#532-kvm_tdp_page_fault-建立页表项)
      - [5.3.2.1. __direct_map(): 构建页表核心](#5321-__direct_map-构建页表核心)
      - [5.3.2.2. kvm_mmu_page: 创建页表页](#5322-kvm_mmu_page-创建页表页)
    - [5.3.2.3. 通过gaddr来索引shadow page table (EPT)](#5323-通过gaddr来索引shadow-page-table-ept)
    - [5.3.2.4. 影子页表迭代器](#5324-影子页表迭代器)
- [6. SPTE设定的辅助函数](#6-spte设定的辅助函数)
- [7. 参考](#7-参考)
...
### 5.3.2.3. 通过gaddr来索引shadow page table (EPT)
...
**level 2 级页表**的**一个页表项**管理地址空间的大小就是  `1 << (12 + 9)` ，即`1 << (12 + (2  - 1) * 9)`
