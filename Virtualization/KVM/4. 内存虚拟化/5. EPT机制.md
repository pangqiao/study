...
- [EPT vm-entry处理](#ept-vm-entry处理)
  - [KVM_REQ_MMU_RELOAD](#kvm_req_mmu_reload)
  - [KVM_REQ_MMU_SYNC](#kvm_req_mmu_sync)
  - [KVM_REQ_TLB_FLUSH](#kvm_req_tlb_flush)
- [EPT VM-exit 处理](#ept-vm-exit-处理)
  - [CR3寄存器](#cr3寄存器)
- [11. 逆向映射机制](#11-逆向映射机制)
- [12. 参考](#12-参考)
