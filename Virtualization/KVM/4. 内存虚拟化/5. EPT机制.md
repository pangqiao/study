...
- [5. EPT构建过程](#5-ept构建过程)
  ...
  - [5.3. EPT异常处理流程](#53-ept异常处理流程)
    ...
    - [5.3.2. kvm_tdp_page_fault(): 建立页表项](#532-kvm_tdp_page_fault-建立页表项)
      ...
      - [5.3.2.3. for_each_shadow_entry: 遍历EPT页表项](#5323-for_each_shadow_entry-遍历ept页表项)
- [6. 参考](#6-参考)
...
#### 5.3.2.3. for_each_shadow_entry: 遍历EPT页表项
...
初始化函数，即CPU拿到一个GPA，构建页表的第一步，构建最初始的`kvm_shadow_walk_iterator`，而关于此结构：
