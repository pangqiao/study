...
- [4. kvm_mmu 结构体: vMMU数据结构](#4-kvm_mmu-结构体-vmmu数据结构)
- [5. kvm_mmu_page: 影子页表页的管理结构](#5-kvm_mmu_page-影子页表页的管理结构)
- [6. kvm中与mmu相关成员](#6-kvm中与mmu相关成员)
- [7. kvm_vcpu中与mmu相关成员](#7-kvm_vcpu中与mmu相关成员)
- [8. 参考](#8-参考)
...
影子页表页，shadow page，就是**装载影子页表**的**页面**，**每个页面**中分为**多个表项**，**每个表项**称为**spte**，注意不论哪个级别，表项都称为spte。
