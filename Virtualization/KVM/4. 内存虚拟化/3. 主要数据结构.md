...
- [kvm_vcpu中与mmu相关成员](#kvm_vcpu中与mmu相关成员)
- [3. kvm_memslots: 虚拟机所有slot信息](#3-kvm_memslots-虚拟机所有slot信息)
- [4. kvm_mem_slot 结构体: 一个代表一段空间, GPA -> HVA](#4-kvm_mem_slot-结构体-一个代表一段空间-gpa-hva)
- [5. kvm_mmu 结构体:](#5-kvm_mmu-结构体)
  - [5.1. kvm_mmu 定义: mmu的操作函数](#51-kvm_mmu-定义-mmu的操作函数)
  - [5.2. kvm_mmu_page: 页表结构](#52-kvm_mmu_page-页表结构)
- [7. 参考](#7-参考)
...
- mmu成员指向vMMU结构，可以看出vMMU是**每VCPU一个**
- `walk_mmu`成员指向mmu
...
# 4. kvm_mem_slot 结构体: 一个代表一段空间, GPA -> HVA
