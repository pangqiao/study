...
int main()
 ...
 |   |   ├─memory_region_init(system_memory, NULL, "system", UINT64_MAX);()             // 初始化 system_memory/io 这两个全局 MemoryRegion
 |   |   ├─ address_space_init(&address_space_memory, )          // address_space_memory->root = system_memory
 |   |   ├─ address_space_init()          // address_space_memory->root = system_memory
 ...
 |   |   |           |
 |   |   |           ├─ address_space_update_topology_pass(AddressSpce, FlatView_old, FlatView_new)
