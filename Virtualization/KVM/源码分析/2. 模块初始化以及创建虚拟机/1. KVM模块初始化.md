...
- [2. kvm_init: 初始化kvm框架](#2-kvm_init-初始化kvm框架)
  ...
  - [2.3. 架构相关的硬件设置](#23-架构相关的硬件设置)
    - [2.4. vmx/svm的硬件配置hardware_setup()](#24-vmxsvm的硬件配置hardware_setup)
        - [2.4.1. 设置全局vmcs_config和vmx_capability](#241-设置全局vmcs_config和vmx_capability)
        - [2.4.2. 一堆检查](#242-一堆检查)
        - [2.4.3. posted中断的wakeup处理函数设置](#243-posted中断的wakeup处理函数设置)
        - [2.4.4. 给每个cpu分配vmcs](#244-给每个cpu分配vmcs)
    - [msr保存到全局变量msrs_to_save[]数组](#msr保存到全局变量msrs_to_save数组)
  - [2.5. 检查处理器对vmx的兼容性](#25-检查处理器对vmx的兼容性)
  - [2.6. 注册CPU状态变化的通知函数](#26-注册cpu状态变化的通知函数)
  - [2.7. 注册reboot时候的通知函数](#27-注册reboot时候的通知函数)
  - [2.8. 分配内存](#28-分配内存)
  - [2.9. 赋值file_operations的模块名](#29-赋值file_operations的模块名)
  - [2.10. 注册设备文件/dev/kvm](#210-注册设备文件devkvm)
  - [2.11. 动作注册](#211-动作注册)
  - [2.12. debugfs初始化](#212-debugfs初始化)
- [3. 参考](#3-参考)
...
### 2.4. vmx/svm的硬件配置hardware_setup()
...
##### 2.4.1. 设置全局vmcs_config和vmx_capability
