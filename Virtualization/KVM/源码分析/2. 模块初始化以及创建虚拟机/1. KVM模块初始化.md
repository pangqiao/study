...
- [2. kvm_init: 初始化kvm框架](#2-kvm_init-初始化kvm框架)
  - [2.1. 架构初始化: kvm_arch_init](#21-架构初始化-kvm_arch_init)
    - [2.1.1. 检查](#211-检查)
    - [fpu_cache分配](#fpu_cache分配)
    - [percpu kvm_shared_msrs](#percpu-kvm_shared_msrs)
    - [mmu模块相关处理](#mmu模块相关处理)
    - [设置全局的kvm_x86_ops](#设置全局的kvm_x86_ops)
    - [设置MMU的shadow PTE masks](#设置mmu的shadow-pte-masks)
    - [timer初始化](#timer初始化)
    - [lapic初始化](#lapic初始化)
  - [workqueue?](#workqueue)
  - [2.2. 架构相关的硬件设置](#22-架构相关的硬件设置)
