...
根据Redhat官方文档的介绍￼，virt\-v2v支持**多种Linux**和**Windows客户机**的迁移和转换，包括：RHEL 4、RHEL 5、RHEL 6、RHEL 7、Windows XP、Windows Vista、Windows 7、Windows Server 2003、Windows Server 2008、Windows Server 2012、Windows Server 2016等。当然，尽管没有官方的声明和支持，通过实际测试还是可以发现，使用virt\-v2v也能够使其他一些类型客户机迁移到KVM（如Fedora、Ubuntu等）。
