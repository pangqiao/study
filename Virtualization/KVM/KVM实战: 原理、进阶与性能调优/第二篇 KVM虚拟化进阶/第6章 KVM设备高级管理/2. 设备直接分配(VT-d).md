...
其中**driver**是设备**使用的驱动**，有很多种类，如**vfio\-pci**表示**VFIO方式**的**PCI设备直接分配**，**virtio\-balloon\-pci**（又为virtio\-balloon）表示**ballooning设备**（这与6.1.3节提到的“-balloon virtio”的意义相同）。prop[=value]是设置驱动的各个属性值。
