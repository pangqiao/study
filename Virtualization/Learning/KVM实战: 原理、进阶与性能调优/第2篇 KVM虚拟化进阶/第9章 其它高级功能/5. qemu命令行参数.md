...
- [回顾已用过的参数](#回顾已用过的参数)
  ...
  - [内存相关的参数](#内存相关的参数)
    - [-m megs参数](#-m-megs参数)
    - [-mem-path path参数](#-mem-path-path参数)
    - [-mem-prealloc参数](#-mem-prealloc参数)
    - [-balloon开启内存气球](#-balloon开启内存气球)
  - [磁盘相关的参数](#磁盘相关的参数)
    - [-hda、-hdb和-cdrom等参数](#-hda-hdb和-cdrom等参数)
    - [-drive参数](#-drive参数)
    - [-boot参数](#-boot参数)
  - [网络相关的参数](#网络相关的参数)
    - [-net nic参数](#-net-nic参数)
    - [-net user或-netdev user参数](#-net-user或-netdev-user参数)
    - [-net tap或-netdev tap/bridge参数](#-net-tap或-netdev-tapbridge参数)
    - [-net dump参数](#-net-dump参数)
    - [-net none参数](#-net-none参数)
  - [图形显示相关的参数](#图形显示相关的参数)
    - [-sdl参数](#-sdl参数)
    - [-vnc参数](#-vnc参数)
    - [-vga参数](#-vga参数)
    - [-nographic参数](#-nographic参数)
  - [VT-d和SR-IOV相关的参数](#vt-d和sr-iov相关的参数)
  - [动态迁移的参数](#动态迁移的参数)
  - [已使用的其他参数](#已使用的其他参数)
    - [-daemonize参数](#-daemonize参数)
    - [-usb参数](#-usb参数)
    - [-enable-kvm参数](#-enable-kvm参数)
- [其他常用参数](#其他常用参数)
  - [-h显示帮助](#-h显示帮助)
  - [-version版本信息](#-version版本信息)
  - [-k键盘布局的语言](#-k键盘布局的语言)
  - [-soundhw声卡硬件支持](#-soundhw声卡硬件支持)
  - [-display显示方式](#-display显示方式)
  - [-name客户机名称](#-name客户机名称)
  - [-uuid系统UUID](#-uuid系统uuid)
  - [-rtc设置RTC开始时间和时钟类型](#-rtc设置rtc开始时间和时钟类型)
  - [存储设备URL](#存储设备url)
    - [iSCSI的URL语法](#iscsi的url语法)
    - [NBD的URL语法](#nbd的url语法)
    - [sheepdog的URL语法](#sheepdog的url语法)
  - [-chardev字符型设备](#-chardev字符型设备)
  - [-bios客户机的BIOS文件](#-bios客户机的bios文件)
  - [-no-reboot和-no-shutdown参数](#-no-reboot和-no-shutdown参数)
  - [-loadvm加载快照状态](#-loadvm加载快照状态)
  - [-pidfile保存进程ID到文件](#-pidfile保存进程id到文件)
