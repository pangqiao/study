...
- [4. kvm_vcpu_arch](#4-kvm_vcpu_arch)
- [5. 结构体之间的关系](#5-结构体之间的关系)
- [6. kvm_x86_ops结构体](#6-kvm_x86_ops结构体)
- [7. KVM API中重要的结构体](#7-kvm-api中重要的结构体)
  - [7.1. kvm_chardev_ops](#71-kvm_chardev_ops)
  - [7.2. kvm_vm_fops](#72-kvm_vm_fops)
  - [7.3. kvm_vcpu_fops](#73-kvm_vcpu_fops)
