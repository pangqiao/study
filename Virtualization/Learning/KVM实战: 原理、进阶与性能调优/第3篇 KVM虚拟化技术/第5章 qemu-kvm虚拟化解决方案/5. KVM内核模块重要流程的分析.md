...
- [](#)
- [4. vCPU的创建](#4-vcpu的创建)
  - [4.1. vCPU的创建过程kvm_vm_ioctl_create_vcpu](#41-vcpu的创建过程kvm_vm_ioctl_create_vcpu)
    - [4.1.1. kvm_arch_vcpu_create创建kvm_vcpu](#411-kvm_arch_vcpu_create创建kvm_vcpu)
    - [4.1.2. kvm_arch_vcpu_setup初始化kvm_vcpu](#412-kvm_arch_vcpu_setup初始化kvm_vcpu)
    - [4.1.3. vCPU检测](#413-vcpu检测)
    - [4.1.4. 创建vcpu_fd](#414-创建vcpu_fd)
    - [4.1.5. 释放内核锁和返回vcpu_fd](#415-释放内核锁和返回vcpu_fd)
- [5. vCPU的运行](#5-vcpu的运行)
...
## 4.1. vCPU的创建过程kvm_vm_ioctl_create_vcpu
...
### 4.1.1. kvm_arch_vcpu_create创建kvm_vcpu
...
### 4.1.2. kvm_arch_vcpu_setup初始化kvm_vcpu
