...
- [任务切换以及VMM的模拟](#任务切换以及vmm的模拟)
- [检查任务切换条件](#检查任务切换条件)
  - [使用 TSS selector 进行任务切换](#使用-tss-selector-进行任务切换)
  - [使用 Task-gate 进行任务切换](#使用-task-gate-进行任务切换)
  - [使用 IRET 进行任务切换](#使用-iret-进行任务切换)
- [VMM 处理任务切换](#vmm-处理任务切换)
- [恢复 guest 运行](#恢复-guest-运行)
- [示例](#示例)
