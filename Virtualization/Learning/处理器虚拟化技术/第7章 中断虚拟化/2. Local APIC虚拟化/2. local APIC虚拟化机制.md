...
* **Virtualize APIC accesses**(虚拟化APIC访问, bit 0). 当为1时, 将**启用APIC-access page页面**. 处理器虚拟化**guest线性访问APIC-access page页面**的行为, 取决于"APIC-register virtualization"位的设置, 产生两种结果:
