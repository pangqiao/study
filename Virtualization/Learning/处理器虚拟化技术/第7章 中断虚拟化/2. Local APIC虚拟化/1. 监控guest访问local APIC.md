...
这个例子，我们可以使用下面的命令进行编译
 ...
 (1) BUILD-DDEBUG RECORD ENABLE-DGUEST ENABLE -D X64-DGUEST X64  (2) BUILD-DDEBUG RECORD ENABLE-DGUEST ENABLE-D X64  (3 BUILD-DDEBUG RECORD ENABLE-DGUEST ENABLE

第 1 个命令将 host 与 guest 都编译为 64 位。第 2 个命令将 host 编译为 64 位，guest

编译为 32 位。第 3 个命令将 host 与 guest都编译为 32位。
