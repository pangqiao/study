...
- [libvirt的架构](#libvirt的架构)
  - [基本架构图](#基本架构图)
  - [接口调用方式](#接口调用方式)
- [从nova到libvirt](#从nova到libvirt)
- [libvirt的接口调用流程](#libvirt的接口调用流程)
- [qemuProcessStart启动qemu进程](#qemuprocessstart启动qemu进程)
- [参考](#参考)
...
https://sq.163yun.com/blog/article/172808502565068800