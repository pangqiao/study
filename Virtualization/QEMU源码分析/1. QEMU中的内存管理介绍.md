...
**结构体MemoryRegion**是联系**guest物理地址空间**和描述**真实内存的RAMBlocks**之间的桥梁。**每个MemoryRegion结构体**中定义了RAMBlock \*ram\_block成员指向其对应的RAMBlock，而在RAMBlock结构体中则定义了struct MemoryRegion *mr指向对应的MemoryRegion。
