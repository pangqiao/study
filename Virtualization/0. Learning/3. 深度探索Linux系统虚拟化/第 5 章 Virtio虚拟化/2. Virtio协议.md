...
- [8. 已用描述符区域](#8-已用描述符区域)
- [9. 三种呈现模式](#9-三种呈现模式)
- [10. virtio-pci 呈现](#10-virtio-pci-呈现)
  - [10.1. 设备要求](#101-设备要求)
  - [10.2. PCI 设备发现](#102-pci-设备发现)
    - [10.2.1. 设备要求](#1021-设备要求)
    - [10.2.2. 驱动要求](#1022-驱动要求)
    - [10.2.3. Legacy Interfaces](#1023-legacy-interfaces)
  - [10.3. 配置数据](#103-配置数据)
    - [10.3.1. virtio legacy](#1031-virtio-legacy)
    - [10.3.2. virtio modern](#1032-virtio-modern)
    - [10.3.3. Common configuration capability](#1033-common-configuration-capability)
    - [10.3.4. Notification capability](#1034-notification-capability)
    - [10.3.5. ISR Status capability](#1035-isr-status-capability)
    - [10.3.6. 设备特定配置的 capability](#1036-设备特定配置的-capability)
    - [10.3.7. PCI 配置空间访问 capability](#1037-pci-配置空间访问-capability)
...
### 10.3.3. Common configuration capability


### 10.3.4. Notification capability


### 10.3.5. ISR Status capability


### 10.3.6. 设备特定配置的 capability

> Device-specific configuration

设备必须至少提供一项 `VIRTIO_PCI_CAP_DEVICE_CFG` capability。

### 10.3.7. PCI 配置空间访问 capability
