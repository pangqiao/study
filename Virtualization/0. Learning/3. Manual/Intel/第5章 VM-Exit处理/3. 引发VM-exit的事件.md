...
* **Interrupt-window exiting**, 当 `Primary processor-based VM-execution control` 字段的 “interrupt-window exiting" 为1 并且`efags.IF=1` 时, 在 VM-enty 后立即产生 VM-exit (参见4.15.7节)
